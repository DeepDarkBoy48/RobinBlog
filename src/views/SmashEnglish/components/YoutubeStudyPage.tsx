...
import { Youtube, Upload, Play, Pause, ChevronRight, Sparkles, AlertCircle, Book, Search, Volume2, Loader2, FileUp } from 'lucide-react';
...
import { AnalysisResult, DictionaryResult } from '../types';
...
export const YoutubeStudyPage: React.FC = () => {
  ...
  const handleAnalyze = async (sub: SubtitleItem) => {
    ...
    setRightPanelTab('analysis'); // Switch to analysis tab
